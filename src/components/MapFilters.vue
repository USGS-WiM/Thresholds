<template>
  <div>
    <v-alert v-if="isFlooding" class="threshold-alert" border="left" dense colored-border type="warning" elevation="2"
      icon="mdi-alert">
      {{ thresholdsExceededMessage }} {{ floodedFeatures() }}
    </v-alert>
    <v-alert v-if="!isFlooding" class="noflooding-alert" border="left" dense colored-border type="success" elevation="2"
        ...
        <v-expansion-panel-content>
          <v-container class="px-0" fluid>
            <v-btn-toggle borderless>
              <v-btn text id="streets" class="basemapBtn" value="Streets" @click="selected = 'Streets'">
                <img class="basemapThumb" alt="" src="../assets/streets.jpg" /><label for="streets">{{
                  this.streets()
                }}</label>
              </v-btn>
              <v-btn text id="satellite" class="basemapBtn" value="Satellite" @click="selected = 'Satellite'">
                <img class="basemapThumb" alt="" src="../assets/satellite.jpg" /><label for="satellite">{{
                  this.satellite()
                }}</label>
              </v-btn>
              <v-btn text id="topo" class="basemapBtn" value="Topo" @click="selected = 'Topo'">
                <img class="basemapThumb" alt="" src="../assets/topo.jpg" /><label for="topo">{{ this.topo() }}</label>
              </v-btn>
              <v-btn text id="terrain" class="basemapBtn" value="Terrain" @click="selected = 'Terrain'">
                <img class="basemapThumb" alt="" src="../assets/terrain.jpg" /><label for="terrain">{{
                  this.terrain()
                }}</label>
              </v-btn>
              <v-btn text id="gray" class="basemapBtn" value="Gray" @click="selected = 'Gray'">
                <img class="basemapThumb" alt="" src="../assets/gray.jpg" /><label for="gray">{{ this.gray() }}</label>
              </v-btn>
              <v-btn text id="natgeo" class="basemapBtn" value="NatGeo" @click="selected = 'NatGeo'">
                <img class="basemapThumb" alt="" src="../assets/natgeo.jpg" />NatGeo<label for="natgeo"></label>
              </v-btn>
            </v-btn-toggle>
          </v-container>
        </v-expansion-panel-content>
        ...
        <v-expansion-panel-content id="siteLayersContent">
          <v-container class="px-0" fluid>
            ...
            <div id="activeSublayers">
              <div id="bankDiv">
                <v-simple-checkbox type="checkbox" ref="bank" id="bank" value="true" :disabled="bankDisabled"
                  v-model="bankPicked"></v-simple-checkbox>
                <div class="sublayer-icon">
                  <img class="activeIcons" src="../assets/aq-icons/embankment_flooded_circle.png" />
              ...
              <div id="pathDiv">
                <v-simple-checkbox type="checkbox" ref="path" id="path" value="true" :disabled="pathDisabled"
                  v-model="pathPicked"></v-simple-checkbox>
                <div class="sublayer-icon">
                  <img class="activeIcons" src="../assets/aq-icons/path_flooded_circle.png" />
              ...
              <div id="roadDiv">
                <v-simple-checkbox type="checkbox" ref="road" id="road" value="true" :disabled="roadDisabled"
                  v-model="roadPicked"></v-simple-checkbox>
                <div class="sublayer-icon">
                  <img class="activeIcons" src="../assets/aq-icons/car_flooded_circle.png" />
              ...
              <div id="bridgeRiskDiv">
                <v-simple-checkbox type="checkbox" ref="bridgeRisk" id="bridgeRisk" value="true"
                  :disabled="bridgeRiskDisabled" v-model="bridgeRiskPicked"></v-simple-checkbox>
                <div class="sublayer-icon">
                  <img class="activeIcons" src="../assets/aq-icons/bridge_risk_circle.png" />
              ...
              <div id="bridgeDiv">
                <v-simple-checkbox type="checkbox" ref="bridge" id="bridge" value="true" :disabled="bridgeDisabled"
                  v-model="bridgePicked"></v-simple-checkbox>
                <div class="sublayer-icon">
                  <img class="activeIcons" src="../assets/aq-icons/bridge_flooded_circle.png" />
              ...
              <div id="facilityDiv">
                <v-simple-checkbox type="checkbox" ref="facility" id="facility" value="true"
                  :disabled="facilityDisabled" v-model="facilityPicked"></v-simple-checkbox>
                <div class="sublayer-icon">
                  <img class="activeIcons" src="../assets/aq-icons/building_flooded_circle.png" />
              ...
              <div id="bfeDiv">
                <v-simple-checkbox type="checkbox" ref="bfe" id="bfe" value="true" :disabled="bfeDisabled"
                  v-model="bfePicked"></v-simple-checkbox>
                <div class="sublayer-icon">
              ...
              <div id="otherDiv">
                <v-simple-checkbox type="checkbox" ref="other" id="other" value="true" :disabled="otherDisabled"
                  v-model="otherPicked"></v-simple-checkbox>
                <div class="sublayer-icon">
            ...
            <div id="showAllBtn">
              <v-btn id="showAll" small outlined color="blue lighten-1" @click="callShowAll"
                :disabled="showAllDisabled">{{ this.showActive() }}</v-btn>
            </div>
            <v-simple-checkbox type="checkbox" ref="allRP" id="allRP" value="true"
              v-model="allRPPicked"></v-simple-checkbox>
            ...
            <v-icon class="opIcon" @click="showAllFeaturesSlider = !showAllFeaturesSlider" small color="blue lighten-1"
              dark>
              mdi-circle-opacity
            </v-icon>
            <div v-if="showAllFeaturesSlider" class="sliders">
              {{ this.opacity() }}: &nbsp; {{ allFeaturesOpacity }}
              <v-slider v-model="allFeaturesOpacity" color="grey darken-2" track-color="white" max="1" min="0"
                step="0.01"></v-slider>
            </div>
            <br />
            ...
            <div>
              <v-simple-checkbox type="checkbox" ref="stream" id="stream" value="false" v-model="streamgagePicked"
                :disabled="streamCheckDisabled"></v-simple-checkbox>
              <div class="legend-icon">
                <div class="
                    wmm-circle
                    wmm-mutedblue
                    ...
                    wmm-borderless
                  "></div>
                <label for="stream" class="legend-label">{{ this.streamgageLabel() }}
                </label>
              </div>
            </div>
            <v-icon class="opIcon" @click="showRTSlider = !showRTSlider" small color="blue lighten-1" dark>
              mdi-circle-opacity
            </v-icon>
            <div v-if="showRTSlider" class="sliders">
              {{ this.opacity() }}: &nbsp; {{ rtOpacity }}
              <v-slider v-model="rtOpacity" color="grey darken-2" track-color="white" max="1" min="0"
                step="0.01"></v-slider>
            </div>
            <br />
            ...
            <v-simple-checkbox type="checkbox" ref="nfhl" id="nfhl" value="false"
              v-model="nfhlPicked"></v-simple-checkbox>
            <div class="legend-no-icon">
              <label for="nfhl">{{ this.femaLayer() }}</label>
            </div>
            <v-icon @click="showNFHLSlider = !showNFHLSlider" small color="blue lighten-1" dark>
              mdi-circle-opacity
            </v-icon>
            <div v-if="showNFHLSlider" class="sliders">
              {{ this.opacity() }}: &nbsp; {{ nfhlOpacity }}
              <v-slider v-model="nfhlOpacity" color="grey darken-2" track-color="white" max="1" min="0"
                step="0.01"></v-slider>
            </div>

            <br />

            <v-simple-checkbox type="checkbox" ref="radar" id="radar" value="false"
              v-model="radarPicked"></v-simple-checkbox>
            <div class="legend-no-icon">
              <label for="radar">{{ this.noaaRadarLayer() }}</label>
            </div>
            <v-icon @click="showNWSSlider = !showNWSSlider" small color="blue lighten-1" dark>
              mdi-circle-opacity
            </v-icon>
            <div v-if="showNWSSlider" class="sliders">
              {{ this.opacity() }}: &nbsp; {{ nwsOpacity }}
              <v-slider v-model="nwsOpacity" color="grey darken-2" track-color="white" max="1" min="0"
                step="0.01"></v-slider>
            </div>

            <br />

            <v-simple-checkbox type="checkbox" ref="fww" id="fww" value="false" v-model="fwwPicked"></v-simple-checkbox>
            <div class="legend-no-icon">
              <label for="fww">{{ this.noaaFloodLayer() }}</label>
            </div>
            <v-icon @click="showFWWSlider = !showFWWSlider" small color="blue lighten-1" dark>
              mdi-circle-opacity
            </v-icon>
            <div v-if="showFWWSlider" class="sliders">
              {{ this.opacity() }}: &nbsp; {{ fwwOpacity }}
              <v-slider v-model="fwwOpacity" color="grey darken-2" track-color="white" max="1" min="0"
                step="0.01"></v-slider>
            </div>
            ...
            <v-simple-checkbox type="checkbox" ref="noaa" id="noaa" value="false"
              v-model="noaaPicked"></v-simple-checkbox>
            <div class="legend-icon">
              <div class="
                  wmm-diamond
                  wmm-lime
            ...
            <v-icon class="opIcon" @click="showNOAASlider = !showNOAASlider" small color="blue lighten-1" dark>
              mdi-circle-opacity
            </v-icon>
            <div v-if="showNOAASlider" class="sliders">
              {{ this.opacity() }}: &nbsp; {{ noaaOpacity }}
              <v-slider v-model="noaaOpacity" color="grey darken-2" track-color="white" max="1" min="0"
                step="0.01"></v-slider>
            </div>
            <br />
          </v-container>
